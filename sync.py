...
class ResourcesHTMLParser(HTMLParser):
    ...
    TEXT_FILE_NAMES = {
        ...
        "Tournament-Rules-14.7.2026_Update-FR.pdf": "tournament-rules-fr.txt",
        "Tournament-Rules-14.7.2026_Update-IT.pdf": "tournament-rules-it.txt",
        "Tournament-Rules-7.14.2026_Update_EN.pdf": "tournament-rules-en.txt",
